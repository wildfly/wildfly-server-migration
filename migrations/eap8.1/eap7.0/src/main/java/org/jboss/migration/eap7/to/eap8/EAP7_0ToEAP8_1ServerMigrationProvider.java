...
/**
 * Server migration, from EAP 7.0 to EAP 8.1.
 * @author emmartins
 */
public class EAP7_0ToEAP8_1ServerMigrationProvider implements EAPServerMigrationProvider8_1 {
    ...
    public WildFlyServerMigration10 getServerMigration() {
        ...
        return serverUpdateBuilders.serverUpdateBuilder()
                .standaloneServer(serverUpdateBuilders.standaloneConfigurationBuilder()
                        ...
                        .subtask(new EAP7_0ToEAP8_1UpdateInfinispanSubsystem<>())
                        .subtask(new EAP7_0ToEAP8_1UpdateUndertowSubsystem<>())
