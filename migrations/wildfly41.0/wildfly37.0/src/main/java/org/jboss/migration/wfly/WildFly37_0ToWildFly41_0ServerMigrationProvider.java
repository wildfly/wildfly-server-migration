...
/**
 * Server migration to WFLY 41.0, from WFLY 37.0.
 * @author emmartins
 */
public class WildFly37_0ToWildFly41_0ServerMigrationProvider implements WildFly41_0ServerMigrationProvider {
