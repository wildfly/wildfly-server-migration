...
/**
 * Server migration to WFLY 40.0, from WFLY 40.0.
 * @author emmartins
 */
public class WildFly40_0ToWildFly40_0ServerMigrationProvider implements WildFly40_0ServerMigrationProvider {
    ...
    @Override
    public Class<WildFly40_0Server> getSourceType() {
        return WildFly40_0Server.class;
    }
}
