...
/**
 * Server migration to WFLY 40.0, from WFLY 37.0.
 * @author emmartins
 */
public class WildFly37_0ToWildFly40_0ServerMigrationProvider implements WildFly40_0ServerMigrationProvider {
