...
/**
 * Server migration to WFLY 39.0, from WFLY 38.0.
 * @author emmartins
 */
public class WildFly38_0ToWildFly39_0ServerMigrationProvider implements WildFly39_0ServerMigrationProvider {
    ...
    @Override
    public Class<WildFly38_0Server> getSourceType() {
        return WildFly38_0Server.class;
    }
}
