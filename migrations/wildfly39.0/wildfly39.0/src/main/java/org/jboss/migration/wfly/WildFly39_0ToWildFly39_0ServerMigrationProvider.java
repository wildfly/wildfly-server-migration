...
/**
 * Server migration to WFLY 39.0, from WFLY 39.0.
 * @author emmartins
 */
public class WildFly39_0ToWildFly39_0ServerMigrationProvider implements WildFly39_0ServerMigrationProvider {
    ...
    @Override
    public Class<WildFly39_0Server> getSourceType() {
        return WildFly39_0Server.class;
    }
}
