...
/**
 * Server migration to WFLY 39.0, from WFLY 34.0.
 * @author emmartins
 */
public class WildFly34_0ToWildFly39_0ServerMigrationProvider implements WildFly39_0ServerMigrationProvider {
