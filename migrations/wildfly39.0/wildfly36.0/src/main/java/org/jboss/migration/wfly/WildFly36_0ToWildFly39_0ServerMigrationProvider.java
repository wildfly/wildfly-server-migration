...
/**
 * Server migration to WFLY 39.0, from WFLY 36.0.
 * @author emmartins
 */
public class WildFly36_0ToWildFly39_0ServerMigrationProvider implements WildFly39_0ServerMigrationProvider {
