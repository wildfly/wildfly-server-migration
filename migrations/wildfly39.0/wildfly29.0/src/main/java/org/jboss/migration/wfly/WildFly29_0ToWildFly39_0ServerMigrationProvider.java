...
/**
 * Server migration to WFLY 39.0, from WFLY 29.0.
 * @author emmartins
 */
public class WildFly29_0ToWildFly39_0ServerMigrationProvider implements WildFly39_0ServerMigrationProvider {
