...
/**
 * Server migration to WFLY 37.0, from WFLY 36.0.
 * @author emmartins
 */
public class WildFly36_0ToWildFly37_0ServerMigrationProvider implements WildFly37_0ServerMigrationProvider {
