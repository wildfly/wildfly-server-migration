...
/**
 * Server migration to WFLY 42.0, from WFLY 36.0.
 * @author emmartins
 */
public class WildFly36_0ToWildFly42_0ServerMigrationProvider implements WildFly42_0ServerMigrationProvider {
