...
/**
 * Server migration to WFLY 42.0, from WFLY 41.0.
 * @author emmartins
 */
public class WildFly41_0ToWildFly42_0ServerMigrationProvider implements WildFly42_0ServerMigrationProvider {
    ...
    @Override
    public Class<WildFly41_0Server> getSourceType() {
        return WildFly41_0Server.class;
    }
}
