...
/**
 * Server migration to WFLY 42.0, from WFLY 35.0.
 * @author emmartins
 */
public class WildFly35_0ToWildFly42_0ServerMigrationProvider implements WildFly42_0ServerMigrationProvider {
