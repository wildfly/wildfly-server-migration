...
/**
 * Server migration to WFLY 42.0, from WFLY 42.0.
 * @author emmartins
 */
public class WildFly42_0ToWildFly42_0ServerMigrationProvider implements WildFly42_0ServerMigrationProvider {
    ...
    @Override
    public Class<WildFly42_0Server> getSourceType() {
        return WildFly42_0Server.class;
    }
}
