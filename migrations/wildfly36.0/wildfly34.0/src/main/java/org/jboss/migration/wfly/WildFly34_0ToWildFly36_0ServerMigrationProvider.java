...
/**
 * Server migration to WFLY 36.0, from WFLY 34.0.
 * @author emmartins
 */
public class WildFly34_0ToWildFly36_0ServerMigrationProvider implements WildFly36_0ServerMigrationProvider {
