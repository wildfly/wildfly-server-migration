...
/**
 * Server migration to WFLY 36.0, from WFLY 28.0.
 * @author emmartins
 */
public class WildFly28_0ToWildFly36_0ServerMigrationProvider implements WildFly36_0ServerMigrationProvider {
