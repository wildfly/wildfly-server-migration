...
/**
 * Server migration to WFLY 36.0, from WFLY 33.0.
 * @author emmartins
 */
public class WildFly33_0ToWildFly36_0ServerMigrationProvider implements WildFly36_0ServerMigrationProvider {
