...
/**
 * Server migration to WFLY 36.0, from WFLY 31.0.
 * @author emmartins
 */
public class WildFly31_0ToWildFly36_0ServerMigrationProvider implements WildFly36_0ServerMigrationProvider {
