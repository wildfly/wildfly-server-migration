...
/**
 * Server migration to WFLY 38.0, from WFLY 37.0.
 * @author emmartins
 */
public class WildFly37_0ToWildFly38_0ServerMigrationProvider implements WildFly38_0ServerMigrationProvider {
