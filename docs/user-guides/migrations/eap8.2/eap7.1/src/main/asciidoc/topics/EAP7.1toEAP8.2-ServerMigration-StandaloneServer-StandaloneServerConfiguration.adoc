...
// include doc for each standalone task in EAP7_1ToEAP8_2ServerMigrationProvider.java

:leveloffset: +1

include::EAP7.1toEAP8.2-ServerMigration-ServerConfiguration-MigrateJBossDomainProperties.adoc[]
...
include::EAP7.1toEAP8.2-ServerMigration-StandaloneServer-StandaloneServerConfiguration-MigrateLegacySecurityRealms.adoc[]

include::EAP7.1toEAP8.2-ServerMigration-StandaloneServer-StandaloneServerConfiguration-MigrateLegacySecurityDomains.adoc[]

include::EAP7.1toEAP8.2-ServerMigration-ServerConfiguration-Subsystem-Migrate-keycloak.adoc[]

include::EAP7.1toEAP8.2-ServerMigration-ServerConfiguration-Subsystem-Migrate-picketlink.adoc[]

include::EAP7.1toEAP8.2-ServerMigration-ServerConfiguration-Subsystem-Update-infinispan.adoc[]

include::EAP7.1toEAP8.2-ServerMigration-ServerConfiguration-Subsystem-Update-jgroups.adoc[]

include::EAP7.1toEAP8.2-ServerMigration-ServerConfiguration-Subsystem-Update-undertow.adoc[]
