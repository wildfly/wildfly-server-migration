...
// include doc for each domain task in EAP7_1ToEAP8_2ServerMigrationProvider.java
...
include::EAP7.1toEAP8.2-ServerMigration-ManagedDomain-DomainConfiguration-MigrateLegacySecurityRealms.adoc[]

include::EAP7.1toEAP8.2-ServerMigration-ManagedDomain-DomainConfiguration-MigrateLegacySecurityDomains.adoc[]
