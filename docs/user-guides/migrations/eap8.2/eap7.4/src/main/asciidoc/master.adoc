...
:server-target-productName: JBoss EAP 8.2
:server-target-name: JBoss EAP
:server-target-version: 8.2.0.GA
:server-target-baseDir: jboss-eap-8.2
...
include::{includesDir}/EAP7.4toEAP8.2-ServerMigration-ServerConfiguration-MigrateJBossDomainProperties.adoc[]
...
include::{includesDir}/EAP7.4toEAP8.2-ServerMigration-StandaloneServer-StandaloneServerConfiguration-MigrateLegacySecurityRealms.adoc[]

include::{includesDir}/EAP7.4toEAP8.2-ServerMigration-StandaloneServer-StandaloneServerConfiguration-MigrateLegacySecurityDomains.adoc[]

include::{includesDir}/EAP7.4toEAP8.2-ServerMigration-ServerConfiguration-Subsystem-Migrate-keycloak.adoc[]

include::{includesDir}/EAP7.4toEAP8.2-ServerMigration-ServerConfiguration-Subsystem-Migrate-picketlink.adoc[]

include::{includesDir}/EAP7.4toEAP8.2-ServerMigration-ServerConfiguration-Subsystem-Update-jgroups.adoc[]
...
include::{includesDir}/EAP7.4toEAP8.2-ServerMigration-ManagedDomain-DomainConfiguration-MigrateLegacySecurityRealms.adoc[]

include::{includesDir}/EAP7.4toEAP8.2-ServerMigration-ManagedDomain-DomainConfiguration-MigrateLegacySecurityDomains.adoc[]
