...
:server-source-productName: WildFly 38.0
:server-source-name: WildFly
:server-source-version: 38.0.0.Final
:server-source-baseDir: wildfly-38.0

:server-target-productName: WildFly 41.0
:server-target-name: WildFly
:server-target-version: 41.0.0.Final
:server-target-baseDir: wildfly-41.0
