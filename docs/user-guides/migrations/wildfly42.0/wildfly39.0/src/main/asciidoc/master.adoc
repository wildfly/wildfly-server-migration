...
:server-source-productName: WildFly 39.0
:server-source-name: WildFly
:server-source-version: 39.0.0.Final
:server-source-baseDir: wildfly-39.0

:server-target-productName: WildFly 42.0
:server-target-name: WildFly
:server-target-version: 42.0.0.Final
:server-target-baseDir: wildfly-42.0
...
include::{includesDir}/ServerMigration-ServerConfiguration-RemoveUnsupportedSubsystems-Discovery.adoc[]
...
include::{includesDir}/ServerMigration-ManagedDomain-AddHostExcludes-Discovery.adoc[]
