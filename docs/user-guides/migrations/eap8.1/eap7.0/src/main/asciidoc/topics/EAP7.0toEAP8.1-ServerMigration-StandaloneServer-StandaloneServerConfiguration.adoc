...
// include doc for each standalone task in EAP7_0ToEAP8_1ServerMigrationProvider.java
...
include::EAP7.0toEAP8.1-ServerMigration-StandaloneServer-StandaloneServerConfiguration-MigrateLegacySecurityRealms.adoc[]

include::EAP7.0toEAP8.1-ServerMigration-StandaloneServer-StandaloneServerConfiguration-MigrateLegacySecurityDomains.adoc[]
