...
// include doc for each domain task in EAP7_1ToEAP8_1ServerMigrationProvider.java
...
include::EAP7.1toEAP8.1-ServerMigration-ManagedDomain-DomainConfiguration-MigrateLegacySecurityRealms.adoc[]

include::EAP7.1toEAP8.1-ServerMigration-ManagedDomain-DomainConfiguration-MigrateLegacySecurityDomains.adoc[]
