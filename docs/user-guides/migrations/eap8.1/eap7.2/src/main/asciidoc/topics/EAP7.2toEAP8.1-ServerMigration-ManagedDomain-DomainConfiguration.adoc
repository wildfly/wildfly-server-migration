...
// include doc for each domain task in EAP7_2ToEAP8_1ServerMigrationProvider.java
...
include::EAP7.2toEAP8.1-ServerMigration-ManagedDomain-DomainConfiguration-MigrateLegacySecurityRealms.adoc[]

include::EAP7.2toEAP8.1-ServerMigration-ManagedDomain-DomainConfiguration-MigrateLegacySecurityDomains.adoc[]
