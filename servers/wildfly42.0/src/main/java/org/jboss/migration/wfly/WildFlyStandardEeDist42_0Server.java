...
/**
 * The WildFly 42.0 Standard EE Dist {@link org.jboss.migration.core.Server}.
 * @author emmartins
 */
public class WildFlyStandardEeDist42_0Server extends WildFly42_0Server {
    ...
    public WildFlyStandardEeDist42_0Server(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
