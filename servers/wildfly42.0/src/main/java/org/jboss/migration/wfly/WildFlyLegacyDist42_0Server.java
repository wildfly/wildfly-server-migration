...
/**
 * The WildFly 42.0 Legacy Dist {@link org.jboss.migration.core.Server}.
 * @author emmartins
 */
public class WildFlyLegacyDist42_0Server extends WildFly42_0Server {
    ...
    public WildFlyLegacyDist42_0Server(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
