...
/**
 * The WildFly 40.x Standard EE Dist {@link org.jboss.migration.core.Server}.
 * @author emmartins
 */
public class WildFlyStandardEeDist40_0Server extends WildFlyServer10 implements WildFly40_0Server {

    public static final Extensions EXTENSIONS = Extensions.builder()
            .extensionsExcept(WildFlyStandardDist40_0Server.EXTENSIONS,
    ...
    public WildFlyStandardEeDist40_0Server(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
    ...
    @Override
    public WildFly40_0Server.DistributionType getDistributionType() {
        return WildFly40_0Server.DistributionType.EE_DIST;
    }

    @Override
    public WildFly40_0Server.TechnologyType getTechnologyType() {
        return WildFly40_0Server.TechnologyType.STANDARD;
    }
}
