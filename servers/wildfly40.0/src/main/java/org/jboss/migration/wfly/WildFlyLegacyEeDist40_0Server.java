...
/**
 * The WildFly 40.x Legacy EE Dist {@link org.jboss.migration.core.Server}.
 * @author emmartins
 */
public class WildFlyLegacyEeDist40_0Server extends WildFlyServer10 implements WildFly40_0Server {

    public static final Extensions EXTENSIONS = Extensions.builder()
            .extensionsExcept(WildFlyLegacyDist40_0Server.EXTENSIONS,
    ...
    public WildFlyLegacyEeDist40_0Server(String migrationName, ProductInfo productInfo, Path baseDir, MigrationEnvironment migrationEnvironment) {
