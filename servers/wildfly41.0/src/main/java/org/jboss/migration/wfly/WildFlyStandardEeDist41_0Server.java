...
/**
 * The WildFly 41.x Standard EE Dist {@link org.jboss.migration.core.Server}.
 * @author emmartins
 */
public class WildFlyStandardEeDist41_0Server extends WildFlyServer10 implements WildFly41_0Server {

    public static final Extensions EXTENSIONS = Extensions.builder()
            .extensionsExcept(WildFlyStandardDist41_0Server.EXTENSIONS,
    ...
    public WildFly41_0Server.DistributionType getDistributionType() {
        return WildFly41_0Server.DistributionType.EE_DIST;
    }

    @Override
    public WildFly41_0Server.TechnologyType getTechnologyType() {
        return WildFly41_0Server.TechnologyType.STANDARD;
    }
}
