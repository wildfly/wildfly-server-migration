...
/**
 * Integration tests for *-to-EAP-7.4 migrations.
 *
 ...
 */
public class EAP74MigrationIT extends AbstractMigrationIT {

    static Collection<String> sourceVersions() {
        return discoverSourceVersions("eap7.4", "eap");
    }
