...
/**
 * Integration tests for *-to-EAP-8.0 migrations.
 *
 ...
 */
public class EAP8_0MigrationIT extends AbstractEAPMigrationIT {

    private static final String TARGET_VERSION = "8.0";
