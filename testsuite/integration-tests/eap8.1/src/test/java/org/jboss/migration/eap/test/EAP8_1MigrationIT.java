...
/**
 * Integration tests for *-to-EAP-8.1 migrations.
 *
 ...
 */
public class EAP8_1MigrationIT extends AbstractEAPMigrationIT {

    private static final String TARGET_VERSION = "8.1";
